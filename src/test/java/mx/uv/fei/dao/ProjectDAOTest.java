...
class ProjectDAOTest {
    ...
    void setUp() throws SQLException {
        ...
        projectDetails.setInvestigationLine("Estudio de los diversos métodos y enfoques para la gestión, modelado y " +
        ...
        projectDetails.setRequisites("Tecnologías para la construcción de software, Principios de Construcción de Software," +
        ...
        projectDetails.setInvestigationProjectDescription("La ciberseguridad se ha vuelto un aspecto muy relevante debido " +
        ...
        projectDetails.setReceptionWorkDescription("El presente trabajo tiene como finalidad, realizar un mapeo sistemático" +
        ...
        projectCollaboration.setInvestigationLine("Estudio de los diversos métodos y enfoques para la gestión, modelado " +
                "y desarrollo de software, de manera que se obtenga software de calidad. Gestión de las diversas etapas " +
                "del proceso de desarrollo.");
        projectCollaboration.setApproximateDuration("6 meses");
        projectCollaboration.setModalityId(3);
        projectCollaboration.setReceptionWorkName("Diversidad en equipos de desarrollo y su relación con la calidad de software");
        projectCollaboration.setRequisites("Tecnologías para la construcción de software, Principios de Construcción de " +
        ...
        projectCollaboration.setInvestigationProjectDescription("En la medida que el software cobra mayor relevancia en " +
                "las actividades diarias de una sociedad, el interés por tener productos de software confiables se incrementa." +
                " Algunos estudios muestran una alta prevalencia de problemas de calidad en los productos de software que " +
                "se desarrollan y la relación de estos problemas con la experiencia y capacitación de programadores. Por " +
                "otra parte, ha habido un avance considerable en el diseño de estrategias para mejora de la calidad del " +
                "software, sin embargo, en algunas organizaciones existe resistencia en la adopción de prácticas orientadas" +
                " a la incorporación de dichas estrategias. Por otra parte, el aspecto humano juega un papel fundamental " +
                "en el desarrollo de productos de software de calidad. Existen estudios donde se definen algunas hipótesis" +
                " orientadas a validar si aspectos de diversidad de personalidad están relacionadas positivamente en la " +
                "calidad del producto final.");
        projectCollaboration.setReceptionWorkDescription("El presente trabajo tiene como finalidad realizar una revisión" +
                " sistemática de la literatura sobre la diversidad (personalidad, género, entre otros aspectos) de los" +
                " equipos de desarrollo y la relación que guardan con la calidad de los productos de software que desarrollan." +
                " Adicionalmente, se pretende que la revisión sistemática documente el impacto que tienen los hallazgos " +
                "identificados en la revisión en los productos de software.");
        projectCollaboration.setExpectedResults("Documento que contenga:\n" +
                "- Reporte de la revisión sistemática de la literatura\n" +
                "- Artículo para publicación en evento académico");
        projectCollaboration.setRecommendedBibliography("V. Pieterse, M. Leeu, and M. van Eekelen, \"How personality " +
                "diversity influences team performance in student software engineering teams,\" 2018 Conference on " +
                "Information Communications Technology and Society (ICTAS), 2018, pp. 1-6, doi: 10.1109/ICTAS.2018.8368749.\n" +
                "\n" +
                "Meiyappan Nagappan, Thomas Zimmermann, and Christian Bird. 2013. Diversity in software engineering " +
                "research. In Proceedings of the 2013 9th Joint Meeting on Foundations of Software Engineering (ESEC/FSE 2013)." +
                " Association for Computing Machinery, New York, NY, USA, 466–476. https://doi.org/10.1145/2491411.2491415\n" +
                "\n" +
                "Luiz Fernando Capretz and Faheem Ahmed. 2010. Why do we need personality diversity in software engineering?" +
                " SIGSOFT Softw. Eng. Notes 35, 2 (March 2010), 1–11. https://doi.org/10.1145/1734103.1734111\n" +
                "\n" +
                "G. Catolino, F. Palomba, D. A. Tamburri, A. Serebrenik, and F. Ferrucci, \"Gender Diversity and Women " +
                "in Software Teams: How Do They Affect Community Smells?,\" 2019 IEEE/ACM 41st International Conference " +
