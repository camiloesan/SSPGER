...
class ProjectRequestDAOTest {
    ...
    void setUp() throws SQLException {
        ...
        project.setReceptionWorkDescription("La mejora del proceso de software basado en la medición es hoy en día una " +
                "actividad obligatoria. Esto implica seguimiento continuo del proceso para predecir su " +
